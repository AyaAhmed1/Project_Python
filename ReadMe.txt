...
-password is asterks
-(​ sorry you are blocked) if he is blocked
________________________________________________________________
...
5- make the CRUD page of users in addition to promote user as admin / unpromote user and block / unblock user (details, edit,promote/unpromote(handle by Owner), block/unblock)
...
7- create admin page with links to (users, posts, categories, forbidden words)
________________________________________________________________

8- registration page for user whether the user is trying to register as admin or normal user (opened from the browser directly without admin login) showing attributes of:
...
the normal link for admin is : http://127.0.0.1:8000/socialapp/dashboard
